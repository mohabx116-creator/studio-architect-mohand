import { k as compileDecodeCharMap, c as createLRUCache, t as trimPath, l as rewriteBasepath, m as composeRewrites, p as processRouteTree, n as processRouteMasks, o as resolvePath, q as cleanPath, s as trimPathRight, g as createControlledPromise, u as parseHref, v as executeRewriteInput, w as isDangerousProtocol, x as redirect, b as isRedirect, d as isNotFound, y as findSingleMatch, z as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, A as buildRouteBranch, B as interpolatePath, C as nullReplaceEqualDeep, E as replaceEqualDeep$1, F as last, G as decodePath, H as findFlatMatch, f as functionalUpdate$1, I as findRouteMatch, i as isPromise, e as invariant$1, h as rootRouteId, O as useRouter, W as jsxRuntimeExports, a1 as Outlet, J as hasKeys, K as executeRewriteOutput, a as arraysEqual, r as reactExports, a2 as notFound, V as React, T as exactPathTest, U as removeTrailingSlash, X as isModuleNotFoundError, j as isServer, P as dummyMatchContext, Q as matchContext, Z as escapeHtml, _ as isInlinableStylesheet, $ as getAssetCrossOrigin, Y as useHydrated, M as trimPathLeft, N as joinPaths, a0 as resolveManifestAssetLink, L as encodePathLikeUrl, S as requireReactDom, R as getDefaultExportFromCjs } from "./server-CLcWzaCz.mjs";
...
const appCss = "/assets/styles-hDxg9CGD.css";
...
const Route$5 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "An architecture and interiors practice working between landscape, craft and the quiet measure of light." },
      { property: "og:title", content: "Atelier Voss — Architecture & Interiors" },
      { property: "og:description", content: "An architecture and interiors practice working between landscape, craft and the quiet measure of light." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Atelier Voss — Architecture & Interiors" },
      { name: "twitter:description", content: "An architecture and interiors practice working between landscape, craft and the quiet measure of light." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/2305b6f0-fc97-46e3-b912-630fc8b7c521/id-preview-15014d6d--ff9a6c60-ddc6-4c73-9a18-632f90240846.lovable.app-1778243899957.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/2305b6f0-fc97-46e3-b912-630fc8b7c521/id-preview-15014d6d--ff9a6c60-ddc6-4c73-9a18-632f90240846.lovable.app-1778243899957.png" }
    ],
    links: [
...
const $$splitComponentImporter$3 = () => import("./projects-BYPEa4j1.mjs");
const Route$4 = createFileRoute("/projects")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A selection of residential, commercial, cultural and interior projects by Atelier Voss."
    }, {
      property: "og:title",
      content: "Projects — Atelier Voss"
    }, {
      property: "og:description",
      content: "A selection of architectural works across residential, commercial, cultural and interior typologies."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./contact-rSiCyQn5.mjs");
const Route$3 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Begin a conversation with Atelier Voss. Studios in Paris and Kyoto, working internationally on residential, commercial and cultural commissions."
    }, {
      property: "og:title",
      content: "Contact — Atelier Voss"
    }, {
      property: "og:description",
      content: "Begin a conversation with the studio. New commissions and press inquiries."
    }]
  }),
    ...
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-luxe flex items-center justify-between h-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "font-display text-xl tracking-tight", children: [
            "Atelier ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: "Voss" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-10", children: nav.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: item.to,
              ...
              children: ({ isActive }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative", children: [
                item.label,
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `absolute -bottom-1 left-0 h-px bg-accent transition-all duration-500 ${isActive ? "w-full" : "w-0"}`
                  }
                )
              ] })
            },
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden border-t border-border/60 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "container-luxe py-6 flex flex-col gap-5", children: nav.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: item.to,
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "border-t border-border/60 mt-32", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-luxe py-16 grid gap-12 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display text-2xl", children: [
          "Atelier ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: "Voss" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 max-w-sm text-sm text-muted-foreground leading-relaxed", children: "An architecture and interiors practice working between landscape, craft and the quiet measure of light." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow text-muted-foreground", children: "Studio" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", className: "hover:text-accent transition-colors", children: "About" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/projects", className: "hover:text-accent transition-colors", children: "Projects" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow text-muted-foreground", children: "Visit" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("address", { className: "mt-4 not-italic text-sm text-muted-foreground leading-relaxed", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-luxe py-6 flex flex-col md:flex-row gap-2 md:gap-0 items-start md:items-center justify-between text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Atelier Voss. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "tracking-widest uppercase", children: "Architecture · Interiors · Research" })
    ] }) })
  ] });
}
...
const architect = "/assets/architect-go5n-RyD.jpg";
...
function AboutPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "pt-32 md:pt-40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container-luxe grid md:grid-cols-12 gap-12 items-end", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { className: "md:col-span-7", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow text-muted-foreground", children: "The Studio" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-4 font-display text-5xl md:text-7xl leading-[1.05]", children: [
            "A practice of ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "text-accent", children: "slow" }),
            " architecture."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { className: "md:col-span-5", delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Founded in Paris in 1998 by Elias Voss, the atelier works at the intersection of architecture, interiors and landscape — across Europe, North America and Japan." }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container-luxe mt-24 md:mt-32 grid md:grid-cols-12 gap-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { className: "md:col-span-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[4/5] overflow-hidden bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: architect, alt: "Elias Voss in studio", loading: "lazy", className: "h-full w-full object-cover" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-muted-foreground", children: "Elias Voss · Founder & Principal" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow text-muted-foreground", children: "Philosophy" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 font-display text-2xl md:text-3xl leading-[1.3]", children: "Each project begins with a study of place — the angle of light at noon, the prevailing wind, the texture of a local stone — and ends with the quiet rituals of those who will inhabit it." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed", children: [
            "The studio is intentionally small — a team of fourteen architects, interior designers and craftspeople — allowing close collaboration with clients and a sustained engagement with each commission from concept through to detail. Built work has been published in ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Domus" }),
            ", ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "El Croquis" }),
            " ",
            "and ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Casabella" }),
            "."
          ] }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container-luxe mt-32 md:mt-48", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow text-muted-foreground", children: "Recognition" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 font-display text-4xl md:text-5xl", children: "Selected awards" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-12 divide-y divide-border border-y border-border", children: awards.map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i * 0.04, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "grid grid-cols-12 gap-4 py-6 items-baseline", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "col-span-2 font-display text-xl text-accent", children: a.year }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "col-span-7 font-display text-xl md:text-2xl", children: a.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "col-span-3 text-right text-sm text-muted-foreground", children: a.note })
        ] }) }, a.title)) })
      ] })
    ] }),
...
const $$splitComponentImporter$1 = () => import("./index-BPLnjTHw.mjs");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Selected works of an architecture and interiors practice working between landscape, craft and the quiet measure of light."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const p1 = "/assets/project-1-CfBJZCAA.jpg";
const p2 = "/assets/project-2-DqTcu93o.jpg";
const p3 = "/assets/project-3-CaRp2oFy.jpg";
const p4 = "/assets/project-4-CCay1LXb.jpg";
const p5 = "/assets/project-5-DzkeTNIR.jpg";
const p6 = "/assets/project-6-C1BFXSMV.jpg";
const categories = [
  "All",
  "Residential",
  "Commercial",
...
const projects = [
  {
    ...
    year: 2024,
    area: "640 m²",
    description: "A monolithic family residence carved into the Umbrian hillside. Board-formed concrete and travertine frame uninterrupted views of the valley, while a sequence of courtyards orchestrates light from dawn to dusk.",
  ...
  },
  {
    ...
    year: 2023,
    area: "12,400 m²",
    description: "A workplace defined by daylight. Vertical timber fins modulate solar gain across a fully glazed envelope, framing the harbour beyond and softening the building's civic presence at street level.",
  ...
  },
  {
    ...
    year: 2022,
    area: "2,800 m²",
    description: "A contemplative cultural pavilion conceived as a procession of carved stone volumes. The interplay of mass and shadow creates an atmosphere of stillness for the museum's permanent collection.",
  ...
  },
  {
    ...
    year: 2024,
    area: "320 m²",
    description: "An interior study in restraint. Oak, linen and brushed brass form a calm material palette across a piano nobile of generous, light-filled rooms.",
  ...
  },
  {
    ...
    year: 2023,
    area: "510 m²",
    description: "A pair of cantilevered concrete volumes hover above the Pacific. The house dissolves into the cliff, choreographing the meeting of land, sea and sky.",
  ...
  },
  {
    ...
    year: 2021,
    area: "180 m²",
    description: "A small sacred space defined by a single shaft of light. Vertical timber slats wrap the interior, transforming sunlight into a slow, daily ritual.",
...
const $$splitComponentImporter = () => import("./projects._slug-BxYkea1L.mjs");
const $$splitNotFoundComponentImporter = () => import("./projects._slug-CTJqHvxC.mjs");
const Route2 = createFileRoute("/projects/$slug")({
  loader: ({
    params
  }) => {
  ...
  head: ({
    ...
    meta: [{
      ...
      property: "og:title",
      content: `${loaderData.project.title} — Atelier Voss`
    }, {
      property: "og:description",
      content: loaderData.project.description
    }, {
      property: "og:image",
      content: loaderData.project.cover
    }, {
      name: "twitter:image",
      content: loaderData.project.cover
    }]
...
const ProjectsSlugRoute = Route2.update({
  id: "/$slug",
  path: "/$slug",
